...
namespace Fynydd.Halide
{
    ...
    /// in the Halide configuration section of the web.config file. The time is in seconds.
    /// <example>
    /// <code>
    /// <![CDATA[
    /// <configSections>
    ...
    public static class Caching
    {
        ...
        /// <summary>
        /// Returns the outputCacheTime setting from the Halide Settings within the Web.config file.
        /// </summary>
        public static int OutputCacheTime
        {
            get
            {
                return Config.GetKeyValue<int>("OutputCache.Expiration.Seconds", 300, "Fynydd.Halide");
            }
        }
        ...
        /// in the web.config file under the Halide Settings key "OutputCache.Expiration.Seconds".
        /// </summary>
        /// <param name="key">Unique name of the cached item</param>
        /// <param name="value">Object to store in the cache</param>
        /// <param name="context">HttpContext; defaults to Current</param>
