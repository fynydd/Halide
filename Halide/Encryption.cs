...
namespace Fynydd.Halide
{
   /// <summary>
    ...
    public static class Encryption
    {
        ...
        /// by adding an Encryption.BaseKey attribute to the Halide Settings
        ...
        public static byte[] basekey1
        {
            get
            {
                string key = Config.GetKeyValue<string>("Encryption.BaseKey", "", "Fynydd.Halide");
        ...
        /// You should change these numbers for your individual use
        /// by adding an Encryption.InitVector attribute to the Halide Settings
        /// config setting within the web.config file.
        /// </summary>
        public static byte[] iv
        {
            get
            {
                string key = Config.GetKeyValue<string>("Encryption.InitVector", "", "Fynydd.Halide");
        ...
        {
            string key = Config.GetKeyValue<string>("Encryption.BaseKey", "", "Fynydd.Halide");
            string ivec = Config.GetKeyValue<string>("Encryption.InitVector", "", "Fynydd.Halide");
