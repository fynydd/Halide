...
namespace Fynydd.Halide
{
    ...
    /// 
    /// Add a reference to the Halide configuration section in your Web.config file as below.
    /// ]]>
    /// <example>
    /// <code>
    /// <![CDATA[
    ...
    public static class Configuration
    {
        ...
        /// <param name="sectionName">Optional section name (e.g. "Fynydd.Halide")</param>
