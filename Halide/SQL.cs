...
namespace Fynydd.Halide
{
    ...
    public static class SQL
    {
        ...
        public static T Lookup<T>(string sqlCommand, string connectionStringName = "Halide", int timeout = 30)
        {
            T result = default(T);
        ...
        public static bool Exec(string statement, string connectionStringName = "Halide", int timeout = 30)
        {
            bool result = false;
        ...
        public static string PowerExec(string procedureName, string[] paramNames, string[] paramValues, bool returnsValue = true, string connectionStringName = "Halide", int timeOut = 30)
        {
        ...
        public static DataTable ReadTable(string statement, string connectionStringName = "Halide")
        {
